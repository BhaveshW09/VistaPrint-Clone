...
import { fetchProductsByIDAsync } from "../Redux/Products/ProductSlice";
            ...
            <div className="col-span-4 pt-8 lg:pt-0">
              <div className="mb-7 border-b border-gray-300 pb-7">
                ...
                <p className="text-body text-sm leading-6  lg:text-base lg:leading-8">
                  ...
                  panels are the muscles, the lace loops are the shoe&apos;s
                  ribs and the mesh in the upper is the skin.
                </p>
